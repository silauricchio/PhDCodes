...
source = '/eos/atlas/atlascerngroupdisk/phys-hdbs/dbl/YXH/superNtuples_v1.9/Skimmed/mc16d/' 
save_dir = '/eos/user/s/sauricch/ReaderOutput/SuperNtuples_v1.9_skimmed/mc16d/'
